      ...
      <div className="w-full">
        ...
        <div className="mb-4 text-white">
          <input
            ...
            className="px-4 py-4 w-full bg-[#333] rounded-[4px] focus:bg-[#4d4c4c] focus-visible:outline-none text-sm"
          />
        ...
        <div className="text-md mt-8 flex items-center gap-2">
          ...
          <Link to={PAGE.SIGNIN} className="text-white text-sm hover:underline">
            Sign in now
          </Link>
        </div>
      </div>
